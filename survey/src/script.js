...
const table = document.getElementById('editableTable');
        ...
        // Add a new row with editable cells
        function addNewRow() {
        ...
        tbody.addEventListener('keydown', (e) => {
            ...
            // Backspace: Move left or delete row if empty
            else if (e.key === 'Backspace' && cell.textContent.trim() === '') {
                e.preventDefault();
                ...
                if (isFirstCell) {
                    if (tbody.rows.length > 1) {
                        ...
                        row.remove();
                        if (prevRow) {
                            setTimeout(() => prevRow.cells[prevRow.cells.length - 1].focus(), 0);
                        }
                    }
                } else {
                    row.cells[cell.cellIndex - 1].focus();
        ...
        // Paste handling with coordinate conversion
        ...
        // Helper: Check if cell is a coordinate field
        ...
        // Helper: Convert coordinate formats
